...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user","Allowed lowercase letters and digits."); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'Field name on the language of "sourceLanguage".'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'Field type column in the database.'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'Field size column in the database.'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'The minimum value of the field (form validator).'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'Required field (form validator).'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user","Regular expression (example: '/^[A-Za-z0-9\s,]+$/u')."); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'Predefined values (example: 1, 2, 3, 4, 5;).'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'Error message when you validate the form.'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'The value of the default field (database).'); ?></p>
	</div>
	...
	<div class="row">
		...
		<p class="hint"><?php echo Yii::t("user",'Display order of fields.'); ?></p>
	</div>
